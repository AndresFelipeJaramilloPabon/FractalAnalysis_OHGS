...
# Please specify the path to R28 Optimal Design Excel spreadsheet file

loc = (r'--Specify here--') 

# Please specify the path to R28 Non-Optimal 10 Design Excel spreadsheet file  
...
plt.tight_layout()
plt.savefig('Fig_8.tiff', dpi=600,bbox_inches='tight')
