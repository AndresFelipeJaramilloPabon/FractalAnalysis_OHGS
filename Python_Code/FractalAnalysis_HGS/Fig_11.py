...
# Please specify the path to New York Tunnel Optimal Design Excel spreadsheet file

loc = (r'--Specify here--') 

# Please specify the path to New York Tunnel Non-Optimal 10 Design Excel spreadsheet file  
...
plt.tight_layout()
plt.savefig('Fig_11.tiff', dpi=600,bbox_inches='tight')
