...
# Note that the following algorithm was used for Water Distribution Networks with less than 250 nodes
...
LY=mBC*np.array(logLBnew)+bBC
plt.plot(logLBnew,LY,color='darkred',linestyle='dotted')
plt.scatter(logLBnew,logNBnew,s=15)
plt.xlabel('log $l_B$')
plt.ylabel('log $N_B$')
plt.tight_layout()
